...
>(({ className, children, size = 'md', ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogClose className="absolute right-4 top-4 rounded-lg p-1 opacity-70 transition-opacity hover:opacity-100 hover:bg-slate-100 dark:hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-purple-500 disabled:pointer-events-none">
        <X className="h-4 w-4" />
